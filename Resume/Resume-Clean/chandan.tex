...
\begin{tightemize}
		...
		% \item ** Developed other characterization setups for LEDs as necessary with Fusion360
...
\begin{tightemize}
	...
	\item Core synthesizable on FPGA and successfully run simple programs 
\end{tightemize}
\sectionsep
...
\begin{tightemize}
	...
	\item improved ML models for real-time beamforming and voice isolation, inference time improved \textbf{5x} while maintaining performance
\end{tightemize}
\sectionsep
